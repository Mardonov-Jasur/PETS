...
exports.member_type_enums = ["USER", "ADMIN", "STORE"];
exports.member_status_enums = ["ONPAUSE", "ACTIVE", "DELETED"];
exports.ordernary_enums = ["Y", "N"];

exports.product_related_enums = ["dogs", "cats", "fishes", "birds"];
exports.product_collection_enums = ["house", "toys", "food", "etc"];
exports.product_volume_enums = [1, 1.5, 2, 5, 10];
